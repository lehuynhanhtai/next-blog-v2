...
export default function About() {
  return (
    <>
      <section className="py-14 lg:py-24 relative z-0 dark:bg-slate-600 bg-slate-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
          <h1 className="max-w-2xl mx-auto text-center font-manrope font-bold text-4xl  text-gray-900 mb-5 md:text-5xl md:leading-normal dark:text-white">
            Control your Finances with our <span className="text-indigo-600 dark:text-indigo-500">Smart Tool </span>
          </h1>
          <p className="max-w-sm mx-auto text-center text-base font-normal leading-7 text-gray-500 mb-9 dark:text-white">Invest intelligently and discover a better way to manage your entire wealth easily.</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-9">
            ...
            <div className="lg:pl-[100px] flex items-center">
              <div className="data w-full">
                <h2 className="font-manrope font-bold text-4xl lg:text-5xl text-black mb-9 max-lg:text-center relative dark:text-white">About Us </h2>
                <p className="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto dark:text-gray-300">
                  Driven by a passion for seamless user experiences, meticulously curated pagedone to empower creators, designers, and developers alike. Our mission is to provide a comprehensive toolkit, enabling you to build intuitive,
                  beautiful interfaces that resonate with users on every interaction.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="lg:pr-24 flex items-center">
              <div className="data w-full">
                ...
                <p className="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto dark:text-gray-300">
                  ...
                  is meticulously crafted to enhance functionality and elevate user satisfaction.
                </p>
              </div>
            </div>
            <div className="img-box ">
      ...
      <section className="py-20 dark:bg-slate-600 bg-slate-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="font-manrope text-4xl text-center text-gray-900 font-bold mb-14 dark:text-white">Our results in numbers</h2>
          <div className="flex flex-col gap-5 xl:gap-8 lg:flex-row lg:justify-between">
            <div className="w-full max-lg:max-w-2xl mx-auto lg:mx-0 lg:w-1/3 bg-white p-6 rounded-2xl shadow-md shadow-gray-100 dark:bg-gray-300">
              <div className="flex gap-5">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 leading-5"> remarkable growth journey as we continually innovate and drive towards new heights of success.</p>
                </div>
              </div>
            </div>
            <div className="w-full max-lg:max-w-2xl mx-auto lg:mx-0 lg:w-1/3 bg-white p-6 rounded-2xl shadow-md shadow-gray-100 dark:bg-gray-300">
      ...
      <section className="mx-auto w-full max-w-screen-xl pt-20">
      ...
      <section className="py-20 ">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-indigo-600 rounded-2xl p-8 xl:p-11">
            <h2 className="font-manrope text-4xl text-white text-center font-bold mb-4">Đăng ký nhận ưu đãi mới nhất</h2>
            <p className="text-indigo-200 text-center mb-11 max-lg:max-w-2xl mx-auto">
              Tham gia cộng đồng người đăng ký của chúng tôi và nhận thông tin cập nhật thường xuyên được gửi thẳng đến hộp thư đến của bạn. Thật nhanh chóng, dễ dàng và miễn phí
            </p>
            <div className="max-w-md mx-auto lg:bg-transparent max-lg:py-3 lg:rounded-full lg:h-12 lg:p-1.5 lg:flex-row gap-6 lg:gap-0 flex-col flex items-center justify-between">
              <input
                type="text"
                name="email"
              ...
              />
              <button type="submit" className="py-2 px-5 text-sm bg-indigo-500 shadow-md rounded-full  text-white font-semibold hover:bg-indigo-700">
                Đăng ký
              </button>
            </div>
          </div>
